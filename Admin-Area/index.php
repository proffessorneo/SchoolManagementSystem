<?php
    ...
    if($_SERVER['REQUEST_METHOD']=="POST"){
        if(isset($_POST['login'])){
            ...
            $results = mysqli_query($dbconnect, $select_query);
            $row_data= mysqli_fetch_array($results);
...
<body>
    ...
    <nav class="navbar navbar-expand-lg ">
        ...
        <div class="container" id="container">
            <div class="headerbox">
            <h1 class="text-center p-4  fw-bold">ADMIN LOGIN</h1>
            </div>
            ...
            <form method="POST" class="mt-4 pt-4">
                ...
                <button type="submit" name="login" class="btn btn-dark text-light btn-lg  ">Log in</button>
                </div>
